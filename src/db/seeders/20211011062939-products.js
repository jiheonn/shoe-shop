    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          type: '남녀공용',
          registration_date: new Date(2017, 2, 21),
        },
        {
          id: 5,
          brands_id: 1,
          ...
          type: '남녀공용',
          registration_date: new Date(2021, 0, 21),
        },
        {
          id: 6,
          brands_id: 1,
          ...
          type: '남성용',
          registration_date: new Date(2021, 3, 12),
        },
        {
          id: 7,
          brands_id: 1,
          ...
          type: '여성용',
          registration_date: new Date(2021, 4, 7),
        },
        {
          id: 8,
          brands_id: 3,
          ...
          type: '남녀공용',
          registration_date: new Date(2021, 4, 29),
        },
        {
          id: 9,
          brands_id: 3,
          ...
          type: '남녀공용',
          registration_date: new Date(2020, 0, 12),
        },
        {
          id: 10,
          brands_id: 3,
          ...
          type: '남녀공용',
          registration_date: new Date(2019, 11, 13),
        },
        {
          id: 11,
          brands_id: 3,
          ...
          type: '남녀공용',
          registration_date: new Date(2020, 0, 19),
        },
        {
          id: 12,
          brands_id: 2,
          ...
          type: '여성용',
          registration_date: new Date(2021, 2, 21),
        },
        {
          id: 13,
          brands_id: 2,
          ...
          type: '남녀공용',
          registration_date: new Date(2021, 5, 30),
        },
        {
          id: 14,
          brands_id: 2,
          ...
          type: '여성용',
          registration_date: new Date(2021, 6, 1),
        },
      ],
      {},
    )
